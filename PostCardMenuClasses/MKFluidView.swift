...
class MKFluidView: UIView {
    ...
    func initializeTouchRecognizer(ControlPoint: CGPoint, animationBundle aniBundle: AnimationBundle) {
        // TASKS ::
        ...
        if !isAnimating! {
            ...
            UIView.animateWithDuration( aniBundle.duration, delay: aniBundle.delay, options: UIViewAnimationOptions.BeginFromCurrentState  , animations: { () -> Void in
    ...
    func endTouchRecognizer(ControlPoint: CGPoint, callback onComplition:((Void) -> Void )?) {
